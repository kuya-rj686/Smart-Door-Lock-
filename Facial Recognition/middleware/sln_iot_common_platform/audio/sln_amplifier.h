...
/**
 * @brief Sets the loopback error event bits
 *
 * @param event         Event error bits
 */
...
/**
 * @brief Starts a SAI read, enables DMA channel and SAI interrupts for AMP loopback.
 *
 */
void SLN_AMP_LoopbackEnable(void);

/**
 * @brief Stops SAI reads, disables DMA channel and SAI interrupts for AMP loopback.
 *
 */
