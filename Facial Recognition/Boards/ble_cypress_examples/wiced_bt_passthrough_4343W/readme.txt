...
- board uart TX (pin 1 on J8) - connect it to RX pin on converter
- board uart RX (pin 7 on J8) - connect it to TX pin on converter
- board GND (pin 9 on J8)

SLN-VIZNAS-IOT-specific instructions
1. The SLN-VIZNAS-IOT has no OpenSDA port. Simply use the regular USB-C port on board
2. The WiFi/BT module is soldered on the kit, so no additional steps necessary to attach the module.
Prepare the Demo
================
